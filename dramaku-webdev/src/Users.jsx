                        ...
                        <div id="table-container" className="content-section">
                            <div id="forms-input">
                                <form className="d-flex align-items-center mx-auto" style={{ padding: '10px' }}>
                                    <label htmlFor="input-data-forms" className="form-label me-2">Username</label>
                                    <input className="form-control me-5" id="input-data-forms" type="text" aria-label="Username" />
                                    <label htmlFor="input-data-forms-email" className="form-label me-2">Email</label>
                                    <input className="form-control me-5" id="input-data-forms-email" type="email" aria-label="Email" />
                            ...
                            <table className="table table-hover">
                                ...
                                <tbody>
                                    <tr className="table-light">
                                        ...
                                        <td>
                                            <FontAwesomeIcon icon={faShareFromSquare} className="custom-link2" /> | 
                                            <FontAwesomeIcon icon={faPenToSquare} className="custom-link2" /> | 
                                            <FontAwesomeIcon icon={faTrashCan} className="custom-link2" />
                                        </td>
                                    </tr>
                                    <tr className="table-light">
                                        <th scope="row">2</th>
